...
const httpTrigger = (context, req) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        const expense = yield Expense_1.ExpenseModel.findByIdAndUpdate(id, req.body, { new: true });
        if (!expense) {
            throw new Error('Despesa não encontrada!');
        }
        context.res = responseHelpers_1.generateResponse({ message: 'Despesa atualizada com sucesso!', expense }, 200);
    }
    catch (error) {
